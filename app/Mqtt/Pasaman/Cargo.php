    ...
    public function extract()
    {
        ...
        return [
            'cargo' => [
                ...
                'transmission_seal_cp1' => (float) $data['transmission_seal_cp1'],
                'trans_v_bearin_cp1' => (float) $data['trans_v_bearin_cp1'],
                ...
                'transmission_seal_cp3' => (float) $data['transmission_seal_cp3'],
                'trans_v_bearing_cp3' => (float) $data['trans_v_bearing_cp3'],
                ...
                'transmission_seal_bp1' => (float) $data['transmission_seal_bp1'],
                ...
                'trans_v_bearing_sp' => (float) $data['trans_v_bearing_sp'],
                'not_used' => (float) $data['not_used'],
                ...
                'trans_v_bearing_tcp' => (float) $data['trans_v_bearing_tcp'],
                'not_used_1' => (float) $data['not_used_1'],
                ...
                'airgas_separatorcp1' => (float) $data['airgas_separatorcp1'],
                'airgas_separator_cp2' => (float) $data['airgas_separator_cp2'],
                'airgas_separator_cp3' => (float) $data['airgas_separator_cp3'],
                ...
                'discharge_press_cp1' => (float) $data['discharge_press_cp1'],
                'discharge_press_cp2' => (float) $data['discharge_press_cp2'],
                'discharge_press_cp3' => (float) $data['discharge_press_cp3'],
                'discharge_press_sp' => (float) $data['discharge_press_sp'],
