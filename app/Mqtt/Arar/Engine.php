    ...
    public function extract()
    {
        ...
        if(! empty($d0)) {
            $d0 = [
                ...
                "me_lo_press_con_value" => (float) ($d0[4] ?? 0) * 0.01,
                "me_fo_press_con_value" => (float) ($d0[5] ?? 0) * 0.01,
                "me_h_temp_fw_press_con_value" => (float) ($d0[6] ?? 0) * 0.01,
                "booster_air_pressure_con_value" => (float) ($d0[7] ?? 0) * 0.01,
                "control_air_pressure_con_value" => (float) ($d0[8] ?? 0) * 0.01,
                "me_lo_inlet_temp_con_value" => (float) ($d0[9] ?? 0) * 0.1,
                "me_fw_high_temp_outlet_temp_con_value" => (float) ($d0[10] ?? 0) * 0.1,
                "me_booster_air_emp_con_value" => (float) ($d0[11] ?? 0) * 0.1,
                "me_exh_no1_cyl_temp_con_value" => (float) ($d0[12] ?? 0) * 0.1,
                "me_exh_no2_cyl_temp_con_value" => (float) ($d0[13] ?? 0) * 0.1,
                "me_exh_no3_cyl_temp_con_value" => (float) ($d0[14] ?? 0) * 0.1,
                "me_exh_no4_cyl_temp_con_value" => (float) ($d0[15] ?? 0) * 0.1,
                "me_exh_no5_cyl_temp_con_value" => (float) ($d0[16] ?? 0) * 0.1,
                "me_exh_no6_cyl_temp_con_value" => (float) ($d0[17] ?? 0) * 0.1,
                "me_exh_no7_cyl_temp_con_value" => (float) ($d0[18] ?? 0) * 0.1,
                "me_exh_no8_cyl_temp_con_value" => (float) ($d0[19] ?? 0) * 0.1,
                "tc_exh_in_temp1_con_value" => (float) ($d0[20] ?? 0) * 0.1,
                "tc_exh_in_temp2_con_value" => (float) ($d0[21] ?? 0) * 0.1,
                "tc_exh_out_temp_con_value" => (float) ($d0[22] ?? 0) * 0.1,
            ];
        }
        ...
        if(! empty($d400)) {
            $d400 = [
                ...
                "me_lo_press_set_high" => (float) ($d400[4] ?? 0) * 0.01,
                "me_fo_press_set_high" => (float) ($d400[5] ?? 0) * 0.01,
                "me_h_temp_fw_press_set_high" => (float) ($d400[6] ?? 0) * 0.01,
                "booster_air_pressure_set_high" => (float) ($d400[7] ?? 0) * 0.01,
                "control_air_pressure_set_high" => (float) ($d400[8] ?? 0) * 0.01,
        ...
        if(! empty($d500)) {
            $d500 = [
                // D500
                "me_rev_speed_set_low" => (float) $d500[0] ?? 0,
                "tc_rev_speed_set_low" => (float) $d500[1] ?? 0,
                "me_fo_rack_set_low" => (float) $d500[2] ?? 0,
                "propeller_rev_set_low" => (float) $d500[3] ?? 0,
                "me_lo_press_set_low" => (float) ($d500[4] ?? 0) * 0.01,
                "me_fo_press_set_low" => (float) ($d500[5] ?? 0) * 0.01,
                "me_h_temp_fw_press_set_low" => (float) ($d500[6] ?? 0) * 0.01,
                "booster_air_pressure_set_low" => (float) ($d500[7] ?? 0) * 0.01,
                "control_air_pressure_set_low" => (float) ($d500[8] ?? 0) * 0.01,
                "me_lo_inlet_temp_set_low" => (float) $d500[9] ?? 0,
                "me_fw_high_temp_outlet_temp_set_low" => (float) $d500[10] ?? 0,
                "me_booster_air_emp_set_low" => (float) $d500[11] ?? 0,
                "me_exh_no1_cyl_temp_set_low" => (float) $d500[12] ?? 0,
                "me_exh_no2_cyl_temp_set_low" => (float) $d500[13] ?? 0,
                "me_exh_no3_cyl_temp_set_low" => (float) $d500[14] ?? 0,
                "me_exh_no4_cyl_temp_set_low" => (float) $d500[15] ?? 0,
                "me_exh_no5_cyl_temp_set_low" => (float) $d500[16] ?? 0,
                "me_exh_no6_cyl_temp_set_low" => (float) $d500[17] ?? 0,
                "me_exh_no7_cyl_temp_set_low" => (float) $d500[18] ?? 0,
                "me_exh_no8_cyl_temp_set_low" => (float) $d500[19] ?? 0,
                "tc_exh_in_temp1_set_low" => (float) $d500[20] ?? 0,
                "tc_exh_in_temp2_set_low" => (float) $d500[21] ?? 0,
                "tc_exh_out_temp_set_low" => (float) $d500[22] ?? 0,
            ];
        }
