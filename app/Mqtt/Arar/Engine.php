    ...
    public function extract()
    {
        ...
        if(! empty($d500)) {
            $d500 = [
                ...
                "me_lo_press_set_low" => (float) $d500[4] ?? 0,
                "me_fo_press_set_low" => (float) $d500[5] ?? 0,
                "me_h_temp_fw_press_set_low" => (float) $d500[6] ?? 0,
                "booster_air_pressure_set_low" => (float) $d500[7] ?? 0,
                "control_air_pressure_set_low" => (float) $d500[8] ?? 0,
