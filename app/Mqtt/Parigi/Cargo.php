...
class Cargo
{
    ...
    public function extract()
    {
        ...
        return [
            'cargo' => [
                'cargo_timestamp' => $data['ts'] ?? Carbon::now()->format('Y-m-d H:i:s'),
                'bottom_gear_cp1' => $data['bottom_gear_cp1'],
                'pump_casing_c1' => $data['pump_casing_c1'],
                'upper_gear_cp1' => $data['upper_gear_cp1'],
                'transmission_seal_c1' => $data['transmission_seal_c1'],
                'trans_v_bearing_c1' => $data['trans_v_bearing_c1'],
                ...
                'transmission_v_bearing_sp' => $data['transmission_v_bearing_sp'],
                ...
                'transmission_v_bearing_tcp' => $data['transmission_v_bearing_tcp'],
                ...
                'discharge_cp1' => $data['discharge_cp1'],
                'discharge_cp2' => $data['discharge_cp2'],
                'discharge_cp3' => $data['discharge_cp3'],
                'dicharge_press_sp' => $data['dicharge_press_sp'],
