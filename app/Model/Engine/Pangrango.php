    ...
    public static function table($fleetId)
    {
        ...
        if(! Schema::hasTable($tableName)) {
            ...
            Schema::create($tableName, function (Blueprint $table) {
                ...
                $table->float('me_exh_vv_drive_oil_inlet_pressure', 10, 3)->default(0);
                $table->float('me_scav_air_pressure', 10, 3)->default(0);
                ...
                $table->float('no1_main_air_bottle_pressure', 10, 3)->default(0);
                $table->float('no2_main_air_bottle_pressure', 10, 3)->default(0);
                $table->timestamps();
            });
        }
