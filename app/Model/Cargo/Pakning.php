...
use Carbon\Carbon;
use App\Model\Cargo\PakningLog;
use Hyperf\Database\Schema\Schema;
use Hyperf\DbConnection\Model\Model;
use Hyperf\Database\Schema\Blueprint;
use Hyperf\Database\Model\Events\Updated;

class Pakning extends Model
{
    /**
    ...
    public function updated(Updated $event)
    {
        ...
        $last = PakningLog::table($model->vessel_id, $date)->orderBy('terminal_time', 'desc')->first();
        ...
        return PakningLog::table($model->vessel_id, $date)->updateOrCreate([
