...
class Gerong extends Model
{
    ...
    public function updated(Updated $event)
    {
        ...
        $last = GerongLog::table($model->vessel_id, $date)->orderBy('terminal_time', 'desc')->first();
        ...
        return GerongLog::table($model->vessel_id, $date)->updateOrCreate([
