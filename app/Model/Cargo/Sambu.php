...
use Carbon\Carbon;
use App\Model\Cargo\SambuLog;
use Hyperf\Database\Schema\Schema;
use Hyperf\DbConnection\Model\Model;
use Hyperf\Database\Schema\Blueprint;
use Hyperf\Database\Model\Events\Updated;

class Sambu extends Model
{
    /**
    ...
    public function updated(Updated $event)
    {
        ...
        $last = SambuLog::table($model->vessel_id, $date)->orderBy('terminal_time', 'desc')->first();
        ...
        return SambuLog::table($model->vessel_id, $date)->updateOrCreate([
